...
export function MediaLab() {
  ...
  const projects = t.raw("projects") as Array<{
    ...
    metric: string; metricLabel: string; description: string; image: string;
  }>;
...
function ProjectCard({
  ...
  project: { title: string; category?: string; metric: string; metricLabel: string; description: string; image: string };
  large?: boolean;
}) {
  return (
